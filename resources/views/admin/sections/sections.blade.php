            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        "href="{{ url('admin/add-edit-section')}}" class="btn btn-primary btn-block"> Add Section</a>
                            ...
                            <table id="item" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item['status']==1)
                                            <a class="updateSectionStatus" id="item-{{ $item['id']}}" item_id="{{ $item['id']}}"
                                        ...
                                        <td>
                                            <a href="{{ url('admin/add-edit-section/'.$item['id'] )}}">
                                            ...
                                            <a class="confirmDelete" href="javascript:void(0)" module="section" moduleid="{{ $item['id']}}">
                                            <i style="font-size:25px;" class="mdi mdi-file-excel-box"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
