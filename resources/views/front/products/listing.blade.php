        ...
        <div class="container">
            ...
            <div class="shop-intro">
                <ul class="bread-crumb">
                    ...
                    <?php echo ($categoryDetails['breadcumbs']);?>
                </ul>
            </div>
            <!-- Shop-Intro /- -->
            <div class="row">
                    ...
                    <div class="page-bar clearfix">
                            ...
                            <div class="toolbar-sorter">
                                <div class="select-box-wrapper">
                                    ...
                                    <select name="sort" id="sort" class="select-box" >
                                        ...
                                        <option value="product_latest" @if(isset($_GET['sort']) && $_GET['sort']=="product_latest")  selected="" @endif>Sort By: Latest Product</option>
                        ...
                        <div class="toolbar-sorter-2">
                            <div class="select-box-wrapper">
                                <label class="sr-only" for="show-records">Show Records Per Page</label>
                                <select class="select-box" id="show-records">
                                    <option selected="selected" value="">Showing: {{count($productDetails)}}</option>
                                </select>
                            </div>
                        </div>
