...
class Category extends Model
{
    ...
    public static function categoryDetails($url){
        ...
        if($categoryDetails['parent_id']==0){
            // Show Main category In Breadcumb

            $breadcumbs = '<li class="is-marked">
            ...
            $breadcumbs = '<li class="has-separator">
        ...
        // dd($catIds);
        $resp = array('catIds'=>$catIds,'categoryDetails'=>$categoryDetails,'breadcumbs'=>$breadcumbs);
        return $resp;
    }
